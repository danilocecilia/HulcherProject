<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMasterPage.Master" AutoEventWireup="true"
    CodeBehind="DPIReport.aspx.cs" Inherits="Hulcher.OneSource.CustomerService.Web.DPIReport" %>
...
<asp:Content ID="PageContent" ContentPlaceHolderID="Content" runat="server">
    <div style="width: 100%">
        <div class="mainTitle">
            <asp:Label ID="lblMainTitle" runat="server" Font-Size="Large" Font-Bold="true" Text="DPI Report" />
        </div>
    </div>
    <hr />
</asp:Content>
